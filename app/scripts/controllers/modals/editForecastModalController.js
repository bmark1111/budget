...
app.controller('EditForecastModalController', ['$q', '$scope', '$rootScope', '$modalInstance', 'RestData2', 'params', 'Categories', 'BankAccounts', 'Periods',

	function($q, $scope, $rootScope, $modalInstance, RestData2, params, Categories, BankAccounts, Periods) {
