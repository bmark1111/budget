...
//		return $resource('//rest.budget.loc/data/:object/:action/:param', {}, {
				...
				getSheet:					{ method: 'GET', headers: headers, params: {object: 'sheet', action: 'load', param: null} },
				...
				reconcileTransactions:		{ method: 'POST', headers: headers, params: {object: 'rest', action: 'reconcileTransactions', param: null} },
