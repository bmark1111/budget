...
/*
 * ------------------------------------------------------
 *  Define our custom exception handler for Proove Bio
 *  This is a change to the CI Core Must Maintain With Upgrades
 * ------------------------------------------------------
 */
    require(SHAREPATH.'system/ep_exception_handler'.EXT);
...
//error_reporting(E_ALL);	// Mark a start point so we can benchmark the controller
