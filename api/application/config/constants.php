...
//define("SECURITY_TOKEN", "mAJgS4NXQNbGIo3ORZLuVfxV");

//main s3 bucket
//define('S3','helixgrader');
//define('S3','grader-staging-dev');
//define('S3','reports-df-dev');
//scan upload destination
//define('GRADERUPLOAD','graderupload/');
...
switch(ENVIRONMENT)
{
	...
	case 'alpha':
		// dev lab csv bucket
		define('LABCSV', 'helix-labcsv-dev');
		break;
	case 'beta':
		// beta lab csv bucket
		define('LABCSV', 'helix-labcsv-beta');
		break;
	case 'production':
		define('LABCSV', 'helix-labcsv');
		break;
}
